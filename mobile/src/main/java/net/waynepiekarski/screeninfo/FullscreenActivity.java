...
public class FullscreenActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View prevButton = (View)findViewById(R.id.prev_button);
        if (isTV) {
            Logging.debug ("Detected Android TV, so hiding some non-TV views");
            nextButton.setVisibility(View.GONE);
            prevButton.setVisibility(View.GONE);
        } else {
            Logging.debug("Detected regular Android device with touchscreen, enabling 'next' and 'prev' view");
